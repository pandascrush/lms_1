...
function CourseVideos() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/course/activity/${course}/${module}`)
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/course/${course}/${module}`)
      .then((res) => {
        setChapter(res.data);
        // console.log(res.data);
      });
  ...
  const handleSubmitPreAssessment = () => {
    ...
    axios
      .post(`http://localhost:5000/quiz/savequiz/${userId}/${1}/${module}`, {
        result,
      })
      .then((res) => {
        console.log(res.data);
  ...
  const handleSubmitPostAssessment = () => {
    ...
    axios
      .post(`http://localhost:5000/quiz/savequiz/${userId}/${2}/${module}`, {
        result,
      })
      .then((res) => {
        console.log(res.data);
        ...
        <div className="row">
          ...
          >
            <div className="mt-lg-5">
              ...
              {activeContent === "quiz" && !loading && !error && (
                <div>
                  {isReviewing ? (
                    ...
                    <div className="card quizpart p-4 d-flex flex-column justify-content-center align-items-center mx-2">
                      ...
                      <button className=" p-2 scbtn" onClick={handleViewScore}>
                        View Score
                      </button>
                    </div>
                  ) : content ? (
                    <div className="container">
                      <div className="quizpart p-3 quizparttext">
                        ...
                        <p>
                          ...
                          with the power to bring about a positive shift in your
                          life.
                        </p>
                        <p>
                          Picture this: acquiring a treasure trove of 100
                          exceptional points of wisdom about the spine—knowledge
                          that empowers you to shape your destiny afresh each
                          day henceforth.
                        </p>
                        <p>
                          Know that these questions are composed with deep
                          empathy and with the greatest care, with your personal
                          growth and enlightenment at their core. They are a
                          testament to my dedication to your journey towards a
                ...
                <div>
                  ...
                  {sidebarItems
                    ...
                    .map((item, index) => (
                      <div key={index}>
                        <iframe
                          src={item.page_content.replace(/<\/?p>/g, "")}
                          title="Video"
                          width="100%"
                          height="400"
                          allowFullScreen
